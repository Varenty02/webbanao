...
namespace webbanao.Migrations
{
    ...
    [Migration("20240223114220_migrate_product")]
    partial class migrate_product
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("webbanao.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("webbanao.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("webbanao.Models.Blog.Category", b =>
                {
                    b.HasOne("webbanao.Models.Blog.Category", "ParentCategory")
